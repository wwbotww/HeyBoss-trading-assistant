...
> 归档于 2026-09-16：F0–F4 已完成。下文的“当前实现”、七个页面、环境变量数量及容器状态均指对应阶段，不代表今天的实现或运行状态。现行架构与八个页面见 [技术参考](../technical-reference.md#存储与-web-边界)，操作命令见 [README](../../README.md#打开只读-web-操作台)。
