...
export type MacroRegime = components['schemas']['MacroRegimeResponse']
export type MacroRegimePoint = components['schemas']['MacroRegimePointResponse']
export type MarketEarnings = components['schemas']['MarketEarningsResponse']
export type MarketFundamentals = components['schemas']['MarketFundamentalsResponse']
export type MarketEvents = components['schemas']['MarketEventsResponse']
export type EventSource = components['schemas']['EventSourceResponse']
export type MarketEventDay = components['schemas']['MarketEventDayResponse']
export type EconomicEvent = components['schemas']['EconomicEventResponse']
export type EarningsEvent = components['schemas']['EarningsEventResponse']
export type StockFundamentals = components['schemas']['StockFundamentalsResponse']
export type FundamentalMetric = components['schemas']['FundamentalMetricResponse']
export type EarningsRevisionAggregate = components['schemas']['EarningsRevisionAggregateResponse']
