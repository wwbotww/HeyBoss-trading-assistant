...
export const portfolioFixture = {
  ...
  available_funds: 48_200.5,
  total_cash_value: 1_500,
  age_seconds: 120,
  is_stale: false,
  account_updated_at_utc: '2026-08-15T11:57:00Z',
...
export const marketRadarSummaryFixture = {
  ...
  modules: [
    ...
    },
    {
      ...
      label: 'EPS 修正',
      state: 'partial',
      detail: '当前市场 FY1 三十日盈利修正仅有部分成员可计算。',
    },
  ],
...
export const marketEarningsFixture = {
  source_state: 'available',
  observed_at_utc: '2026-09-04T02:00:00Z',
  validity: 'partial',
  as_of_date: '2026-09-03',
  calculated_at_utc: '2026-09-03T23:20:00Z',
  source: 'eodhd_calendar',
  freshness: { snapshot_age_days: 1, stale_after_days: 3 },
  membership: {
    membership_source: 'state_street_spy_holdings',
    membership_date: '2026-09-03',
    member_count: 503,
    classification_source: 'eodhd_components',
    classification_record_count: 503,
    classified_member_count: 502,
    unclassified_member_count: 1,
    unused_classification_count: 1,
    classification_validity: 'partial',
    classification_coverage_ratio: 502 / 503,
  },
  watchlist: {
    validity: 'complete',
    eligible: 10,
    ...
    unchanged: 2,
    breadth: 0.4,
    magnitude_observed: 10,
    non_positive_or_near_zero: 0,
    median_magnitude: 0.018,
  },
  market: {
    validity: 'partial',
    eligible: 503,
    observed: 501,
    coverage_ratio: 501 / 503,
    upward: 260,
    downward: 210,
    unchanged: 31,
    breadth: 50 / 501,
    magnitude_observed: 480,
    non_positive_or_near_zero: 21,
    median_magnitude: 0.012,
  },
  sectors: [
    {
      ...
      revisions: {
        ...
        unchanged: 10,
        breadth: 22 / 72,
        magnitude_observed: 70,
        non_positive_or_near_zero: 2,
        median_magnitude: 0.024,
      },
    },
    {
      sector_id: 'energy',
      revisions: {
        ...
        eligible: 23,
        observed: 22,
        coverage_ratio: 22 / 23,
        upward: 8,
        downward: 12,
        unchanged: 2,
        breadth: -4 / 22,
        magnitude_observed: 18,
        non_positive_or_near_zero: 4,
        median_magnitude: -0.009,
      },
    },
  ],
} satisfies MarketEarnings
